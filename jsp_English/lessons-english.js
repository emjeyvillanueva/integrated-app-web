if(sessionStorage.getItem("ID") === "1"){
    ...
    var img_loc = [
    "/English Page/img/thumbnail_oral_language.png","/English Page/img/Oral2.png","/English Page/img/Oral3.png","/English Page/img/Oral4.PNG","/English Page/img/Oral5.PNG"
];
    ...
    var img_loc = [
    "/English Page/img/phono1.PNG","/English Page/img/phono2.png","/English Page/img/phono3.png","/English Page/img/phono4.PNG","/English Page/img/phono5.png"
    ];
    for(var temp= 1;temp<=titles.length;temp++){
        Populate(temp,titles[temp-1], img_loc[temp-1]);
    }
    ...
    var img_loc = [
    "/English Page/img/grammar1.PNG","/English Page/img/grammar2.PNG","/English Page/img/grammar3.PNG","/English Page/img/grammar4.PNG","/English Page/img/grammar5.PNG","/English Page/img/grammar6.PNG","/English Page/img/grammar7.PNG"
    ];
    for(var temp= 1;temp<=titles.length;temp++){
        Populate(temp,titles[temp-1], img_loc[temp-1]);
    }
    ...
    var img_loc = [
    "/English Page/img/thumbnail_homonyms.png","/English Page/img/thumbnail_homophones part 2.png","/English Page/img/thumbnail_homophones.png","/English Page/img/thumbnail_synonyms.png","/English Page/img/thumbnail_vocabulary.png"
    ];
    for(var temp= 1;temp<=titles.length;temp++){
        Populate(temp,titles[temp-1], img_loc[temp-1]);
    }
    ...
    var img_loc = [
    "/English Page/img/Lis1.PNG","/English Page/img/Lis2.png","/English Page/img/Lis3.png","/English Page/img/Lis4.png","/English Page/img/Lis5.png"
    ];
    for(var temp= 1;temp<=titles.length;temp++){
        Populate(temp,titles[temp-1], img_loc[temp-1]);
    }
    ...
    var img_loc = [
    "/English Page/img/read1.PNG","/English Page/img/read2.PNG","/English Page/img/read3.PNG","/English Page/img/read4.PNG","/English Page/img/read5.PNG"
    ];
    for(var temp= 1;temp<=titles.length;temp++){
        Populate(temp,titles[temp-1], img_loc[temp-1]);
    }
    ...
    var img_loc = [
    "/English Page/img/LangLit1.png","/English Page/img/LangLit2.PNG","/English Page/img/LangLit3.PNG","/English Page/img/LangLit4.PNG","/English Page/img/LangLit5.PNG","/English Page/img/LangLit6.png","/English Page/img/LangLit7.png"
    ];
    ...
    var img_loc = [
    "/English Page/img/book1.PNG","/English Page/img/book2.PNG","/English Page/img/book3.PNG","/English Page/img/book4.PNG","/English Page/img/book5.PNG"
    ];
